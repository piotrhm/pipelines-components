# OSFT Minimal Eval Hub Pipeline

> **Stability: experimental** — This asset is under active development and may change.

## Overview

OSFT Training Pipeline with Eval Hub evaluation (Minimal) via KServe InferenceService.
...
For the full-featured variant with configurable benchmarks and collections, see `osft_evalhub/`.
...
| `phase_02_train_opt_learning_rate` | `float` | `5e-06` | Learning rate |
...
- **Tags**: training, fine_tuning, osft, eval_hub, kserve, minimal, pipeline
