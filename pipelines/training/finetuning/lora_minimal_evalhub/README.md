# LoRA Minimal Eval Hub Pipeline

> **Stability: experimental** — This asset is under active development and may change.

## Overview

LoRA Training Pipeline with Eval Hub evaluation (Minimal) via KServe InferenceService.
...
For the full-featured variant with configurable benchmarks and collections, see `lora_evalhub/`.
...
- **Tags**: training, fine_tuning, lora, peft, eval_hub, kserve, minimal, pipeline
