# SFT Eval Hub Pipeline

> **Stability: experimental** — This asset is under active development and may change.

## Overview

SFT Training Pipeline with Eval Hub evaluation via KServe InferenceService.
...
For the minimal-config variant, see `sft_minimal_evalhub/`.
...
| `phase_02_train_opt_memory` | `str` | `64Gi` | Memory per worker. |
...
- **Tags**: training, fine_tuning, sft, eval_hub, kserve, pipeline
